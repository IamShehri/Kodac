...
**Phase 1 authorized (2026-07-20)** for exactly: one OpenCode profile, agent-profile JSON Schema, validation tooling, deterministic Markdown generation, tests, and root README integration. **Phase 1-R2 authorized (2026-07-21)** for closing remaining evidence-contract and documentation defects. **Phase 1-R2 independent acceptance was not granted;** seven defects remained (dispute mapping, duplicate disputes, canonical repository URL, immutability classifier, methodology doc, review metadata). **Phase 1-R2A authorized (2026-07-21)** to fix those defects only. Everything else in this plan (the remaining nine profiles, Controlled Evaluation Tasks, Runs, CI beyond local tooling, website, launch) remains unauthorized; Phase 2 requires separate founder authorization.
