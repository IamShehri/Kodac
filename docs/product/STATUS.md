...
Current authority boundaries are reconciled to the already-canonical K3-R1 through K3-R5 state:
...
PROVEN_READY AUTHORITY FROM KRI-P0: NOT AUTHORIZED

CODE IMPORT: NOT AUTHORIZED
NEW KODAC DEPENDENCIES: NOT AUTHORIZED
EXTERNAL REVIEW SERVICE INTEGRATION: NOT AUTHORIZED
REPOSITORY WRITE / GITHUB REVIEW / APPROVAL / MERGE AUTHORITY FROM KRI-P0: NOT AUTHORIZED
